...
import { LayoutGrid, Table, LogOut, User, Database, Activity } from "lucide-react";
  ...
  <img src="/logo.jpg" alt="KMR Logo" className="w-29 h-12 object-cover" />
            ...
            <div className="flex items-center gap-2 relative">
              <button
                ...
                title="Mock Ingestion"
              >
                <Database className="w-5 h-5" />
              </button>

              <button
                onClick={() => navigate("/admin/ingestion-runs")}
                className="p-2 rounded-lg bg-secondary text-muted-foreground hover:text-foreground transition-colors"
              ...
              <button
                onClick={() => navigate("/admin/scored-induction")}
                className="p-2 rounded-lg bg-secondary text-muted-foreground hover:text-foreground transition-colors"
...
<main className="w-full px-6 py-6">
        ...
        {/* Conflicts Banner */}
        <ConflictsBanner 
          conflicts={trainsets.flatMap(t => t.conflicts || [])}
          className="mb-6"
        />
